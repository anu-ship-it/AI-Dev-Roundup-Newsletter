...
const SubscriberSchema = new Schema<ISubscriber>(
    {
        ...
        // Random token used for one-click unsubscribe liinks
...
// Prevent modal recompilation in Next.js hot reload
export default mongoose.models.Subscriber ||
    mongoose.model<ISubscriber>("Subsriber", SubscriberSchema);
